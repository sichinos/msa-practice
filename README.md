# Micro Service Architecture ハンズオン
このハンズオンでは簡易的なモノリスなアプリケーションをデプロイし、次にマイクロサービスに分割することで Micro Service Architecture な構成のアプリケーションを OpenShif クラスタにデプロイする方法を体験します。
...
---
## 4. まとめ
ここまで、サンプルアプリケーションのモノリスアプリケーションをマイクロサービスに分割、デプロイする方法を体験してきました。
